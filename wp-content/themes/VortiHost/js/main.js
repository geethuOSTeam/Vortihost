...
$(document).ready(function () {
  ...
  //========= Mobile Menu Scripts =========//
  $("#header-area .mobile-icon").click(function (e) {
    e.preventDefault();
    $(".mobile-menu").fadeIn();
  });
  ...
  $(window).scroll(function () {
    ...
    $(".page-section").each(function () {
      if ($(this).offset().top - $(window).height() / 4 < scrollDistance) {
        var sectionId = $(this).attr("id");
        $(".navigation__link").removeClass("active");
        $('.navigation__link[href="#' + sectionId + '"]').addClass("active");
      }
    });
  });
...
function openTab(evt, tabName) {
  ...
  tablinks = document.getElementsByClassName("plantablinks");
